  ...
  return (
    <div className="relative flex items-center px-md py-sm">
      ...
      {canScrollLeft && (
        <button
          onClick={() => scroll("left")}
          className="absolute left-1 z-10 flex h-6 w-6 items-center justify-center rounded-full bg-card shadow-sm border border-border"
      ...
      {canScrollRight && (
        <button
          ...
          className="absolute right-1 z-10 flex h-6 w-6 items-center justify-center rounded-full bg-card shadow-sm border border-border"
